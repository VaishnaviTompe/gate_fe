...
const Quizok = () => {
  ...
  //     // Assuming userResponses is an array containing user responses for each question
  ...
  //         // Check if the necessary properties are defined in the response
  //         if (
  //           response.data &&
  //           response.data.unansweredQuestions !== undefined
  //         ) {
  //           console.log("Quiz results:", response.data);
  //           setQuizResults(response.data);

  //           // Navigate to the QuizResult component
  //           navigate("/Success", { state: { quizResults: response.data } });
  //         } else {
  ...
  //       answer: question.response ? question.response.answer : null,
  //     }));
  //     console.log("userResponses:", userResponses); // Add this line to inspect the userResponses array
  //     const token = localStorage.getItem("token");
  //     console.log("Token retrieved from localStorage:", token);
  ...
  return (
    <div className="quiz-background">
      <h5 className="quiz-title">Computer Science Engineering</h5>
