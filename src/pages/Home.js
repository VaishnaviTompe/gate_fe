...
//   //   } catch (error) {
//   //     console.error("Error fetching total users:", error.response.data.error);
...
//       <div className="home-title">GATE</div>
//       <div className="home-subtitle">Graduate Aptitude Test in Engineering</div>
//       <br />
